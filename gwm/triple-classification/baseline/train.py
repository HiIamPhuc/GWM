...
def parse_args():
    ...
    model_group.add_argument('--projector_hidden_dim', type=int, default=2048,
                            help='Hidden dimension for MLP projector (baseline)')
...
def print_config(args: argparse.Namespace):
    ...
    print("\n📊 Task: Link Prediction with Flatten Architecture (Baseline)")
    print(f"   Architecture: Flatten multi-hop embeddings → MLP projector")
    ...
    print(f"   Architecture: BASELINE (flatten)")
...
def main():
    ...
    config_dict['architecture'] = 'baseline-flatten'
    ...
    print(f"✓ Model loaded (Baseline - Flatten)")
